...
//Wifi configurations
const char *ssid = "AddamHotspot";
const char *password = "Addam2911";

String postData ; // post array that will be send to the website
String link = "http://192.168.12.70/biometricattendance/getdata.php"; //computer IP or the server domain
...
void setup() {
  ...
  finger.begin(57600);
  Serial.println("\n\nAdafruit fingerprint sensor detection test");
